...
alias grok='/vagrant/puphpet/files/bin/ngrok -authtoken fVVLLIi6noAoJOIfmuLU -subdomain jagged 80'
alias yum='sudo apt-get'
alias dot='cp /vagrant/puphpet/files/dot/.zshrc ~/.zshrc && . ~/.zshrc'
alias wtf='php artisan cache:clear:all && chmod -R 777 app/storage'
...
#PATHS
export PATH=$PATH:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/vagrant/files/bin:
